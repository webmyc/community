...
Respira now supports two workflows: **Browser AI** (WebMCP built-in) and **Desktop AI** (MCP server). Both share the same safety workflow and 88-tool ecosystem.
...
- [Usage Guide](/usage)
- [Tools Reference](/tools/overview) - Complete list of 88 tools (77 WordPress + 11 WooCommerce)
