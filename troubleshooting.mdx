...
- Respira for WordPress: `4.0.7+`
- MCP server: `3.3.5+`
- WooCommerce taxonomy tooling: plugin `4.0.4+`, MCP `3.3.4+`, Woo add-on `1.0.2+`
...
- Upgrade Respira plugin to `4.0.7+`
- Upgrade MCP server to `3.3.5+`
