...
Update to Respira for WordPress `4.0.7+` and MCP server `3.3.5+`. These releases include fixes for URL-control array payloads, safer fallback writes, and improved structured diagnostics.
